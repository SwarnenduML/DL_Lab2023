...
def main(argv, MODEL_NAME, BAYESIAN_OPT, START_TIME_STAMP, END_TIME_STAMP, RUNS):
    ...
    for i in range(RUNS):
        ...
        if BAYESIAN_OPT == False:
            ...
            model_train = TrainingRoutine(base_model, train_dataset, val_dataset, BAYESIAN_OPT)
        ...
        # if bayesian optimization is required then
            ...
            model_train = TrainingRoutine(base_model, train_dataset, val_dataset, BAYESIAN_OPT = False, learning_rate = learning_rate)
