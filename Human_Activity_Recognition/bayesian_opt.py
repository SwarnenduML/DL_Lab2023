...
#        logging.info(dropout_rate)
        model_train = TrainingRoutine(base_model, self.train_dataset, self.valid_dataset, True, self.EPOCH, self.PATIENCE, learning_rate)
        model_test = TestingRoutine(base_model, self.test_dataset, True)
